    ...
    <div class="max-w-4xl mx-auto space-y-6" 
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-xl font-black text-slate-800 tracking-tight">Edit Data Produk</h2>
            </div>
            <div>
                <a href="{{ route('products.show', $product) }}" class="inline-flex items-center gap-1 px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-xl transition">
            ...
            <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <!-- SKU Code -->
                        <div>
                            <label for="code" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label for="stock" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">
                                Jumlah Stok Fisik <span class="text-rose-500">*</span>
                            </label>
                        ...
                        <div>
                            ...
                            <input id="min_stock" type="number" name="min_stock" value="{{ old('min_stock', $product->min_stock) }}" min="0" required 
                                   class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 transition" />
